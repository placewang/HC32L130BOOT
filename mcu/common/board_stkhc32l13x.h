...
///< SPI0
#define EVB_SPI0_FLASH_CS_PORT      GpioPortA
#define EVB_SPI0_FLASH_CS_PIN       GpioPin4
#define EVB_SPI0_FLASH_SCK_PORT     GpioPortA
#define EVB_SPI0_FLASH_SCK_PIN      GpioPin5
#define EVB_SPI0_FLASH_MISO_PORT    GpioPortA
#define EVB_SPI0_FLASH_MISO_PIN     GpioPin6
#define EVB_SPI0_FLASH_MOSI_PORT    GpioPortA
#define EVB_SPI0_FLASH_MOSI_PIN     GpioPin7
